...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE `fir` SET `firno` = '$fir_id', `firname` = '$name', `firfathername` =  '$fathername',`firmothername` =  '$mothername', `IDnumber` = '$id_num', `phno` = '$phno', `email` = '$email', `datetime` = '$dt', `placeocc` = '$place', `address` = '$addr', `crimedesc`= '$desc', `status` = '$status' WHERE `firno` = '$fir_id'";
