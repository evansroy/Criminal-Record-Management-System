...
if (isset($_POST['bclkfir'])) {
    ...
    $sql = "INSERT INTO `fir` (`firname`, `firfathername`, `firmothername`, `IDnumber`, `phno`, `email`, `datetime`, `placeocc`,  `address`, `crimedesc`, `status`) VALUES ('$name', '$fathername', '$mothername', '$id_num', '$phno', '$email', '$dt', '$place', '$addr', '$desc', '$status')";
