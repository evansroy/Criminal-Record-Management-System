                    ...
                    <div class="box">
                        <div class="right-side">
                            <div class="text">
                                ...
                                <p><b>Complainant's ID Number: </b><?php echo htmlspecialchars($fir['IDnumber']); ?></p>
                                ...
                                <div class="end_button">
                                    ...
                                    <div class="in_button">
                                        <form method="POST" action="firdelete.php">
                                            <input type="hidden" name="id" value="<?php echo $fir['firno'] ?>" />
