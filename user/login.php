...
if (isset($_POST['loginbutton'])) {
    ...
    $sql = mysqli_query($conn, "SELECT * FROM users where IDnumber='$Username' and Pass='$Pass'");
...
<body>
    <div class="loginbox" style="height: 450px;">
        ...
        <form action="login.php" method="post">
            ...
            <?php } ?>
            <label for="username"><b>ID Number</b></label>
            <input type="text" name="uname" placeholder="Enter the ID Number" id="username" required>
