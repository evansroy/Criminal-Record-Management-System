...
$idsql = "SELECT * FROM `users` WHERE `IDnumber`='$user_id'";
...
if ($search) {
    $sql = "SELECT * FROM fir WHERE `firno` LIKE '%$search%' OR `firname` LIKE '%$search%' OR `firfathername` LIKE '%$search%' OR `firmothername` LIKE '%$search%' OR `IDNumber` LIKE '%$search%' OR `phno` LIKE '%$search%' OR `email` LIKE '%$search%' OR `datetime` LIKE '%$search%' OR `placeocc` LIKE '%$search%' OR `address` LIKE '%$search%' OR `crimedesc` LIKE '%$search%' OR `status` LIKE '%$search%'";
} else {
    $sql = "SELECT * FROM query WHERE `IDNumber`='$user_id'";
}
...
<body>
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li>
                <a href="queryanswered.php?id=<?php echo $user_id ?>" class="active">
    ...
    <section class="home-section">
        <nav>
            <div class="sidebar-button">
                ...
                <span class="dashboard">Asked Queries</span>
            </div>
                    ...
                    <div class="box">
                        <div class="right-side">
                            <div class="text">
                                ...
                                <p><b>Name: </b><?php echo htmlspecialchars($query['name']); ?></p>
                                <p><b>ID Number: </b><?php echo htmlspecialchars($query['IDNumber']); ?></p>
