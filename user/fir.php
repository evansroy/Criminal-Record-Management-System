...
if (isset($_POST['report'])) {
    ...
    $sql = "INSERT INTO `fir` (`firname`, `firfathername`, `firmothername`, `IDnumber`, `phno`, `email`, `datetime`, `placeocc`,  `address`, `crimedesc`, `status`) VALUES ('$name', '$fathername', '$mothername', '$id_num', '$phno', '$email', '$dt', '$place', '$addr', '$desc', 'Pending')";
                            ...
                            <div class="content">
                                <form action="fir.php?id=<?php echo $user_id ?>" method="POST">
                                    <div class="user-details">
                                        ...
                                        <div class="input-box">
                                            <span class="details"><label for="adhar">ID Number</label></span>
                                            <input type="tel" id="IDnumber" name="IDnumber" pattern="[0-9]{12}" placeholder="Enter Your ID Number" required>
                                        </div>
