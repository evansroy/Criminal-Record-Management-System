...
if (isset($_POST['askquery'])) {
    ...
    $sql = "INSERT INTO `query` (`name`, `IDnumber`, `phno`, `email`, `query`, `reply`) VALUES ('$name', '$id_num', '$phno', '$email', '$queri', 'Not Yet Replied')";
                            ...
                            <div class="content">
                                <form action="queries.php?id=<?php echo $user_id ?>" method="POST">
                                    <div class="user-details">
                                        ...
                                        <br>
                                        <div class="input-box">
                                            <span class="details"><label for="idNumber">ID Number:</label></span>
                                            <input type="number" id="idNumber" pattern="[0-9]{12}" placeholder="Enter Your ID Number" name="IDNumber" required>
                                        </div>
                                        <div class="input-box">
