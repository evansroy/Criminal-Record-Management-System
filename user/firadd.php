...
if (isset($_POST['report'])) {
    ...
    //SQL query to insert data to the database in fir table 
    $sql = "INSERT INTO `fir` (`firname`, `firfathername`, `firmothername`, `IDnumber`, `phno`, `email`, `datetime`, `placeocc`,  `address`, `crimedesc`) VALUES ('$name', '$fathername', '$mothername', '$id_num', '$phno', '$email', '$dt', '$place', '$addr', '$desc')";
                            ...
                            <div class="content">
                                <form method="POST" action="firadd.php">
                                    <div class="user-details">
                                        ...
                                        <div class="input-box">
                                            <span class="details"><label for="idnumber">Complainant's ID Number:</label></span>
                                            <input type="number" name="idnumber" placeholder="Enter the Complainant's ID Number" id="idnumber" pattern="[0-9]{12}" required>
                                        </div>
                                        <div class="input-box">
