...
if ($search) {
    $sql = "SELECT * FROM query WHERE `qid` LIKE '%$search%' OR `name` LIKE '%$search%' OR `IDnumber` LIKE '%$search%' OR `phno` LIKE '%$search%' OR `email` LIKE '%$search%' OR `query` LIKE '%$search%' OR `reply` LIKE '%$search%'";
} else {
