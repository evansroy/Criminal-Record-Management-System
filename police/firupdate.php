...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE `fir` SET `status` = '$status' WHERE `firno` = '$fir_id'";
                                ...
                                <form method="POST">
                                    <div class="user-details">
                                        ...
                                        <div class="input-box">
                                            ...
                                            <input type="text" name="mname" value="<?php echo $mname ?>" disabled>
                                        </div>
                                        <div class="input-box">
                                            <span class="details"><label>Complainant's ID Number:</label></span>
                                            <input type="number" name="idnumber" value="<?php echo $id_num ?>" disabled>
                                        </div>
                                        <div class="input-box">
                                            <span class="details"><label>Complainant's Contact Number:</label></span>
                                            <input type="number" name="phno" value="<?php echo $cno ?>" disabled>
                                        </div>
                                        <div class="input-box">
                                        ...
                                        <div class="input-box">
                                            ...
                                            <input type="datetime" name="dt" value="<?php echo $dattim ?>" disabled>
                                        </div>
                                        <div class="input-box">
                                            <span class="details"><label>Place of Occurence of the Crime:</label></span>
                                            <input type="text" name="place" value="<?php echo $occ ?>" disabled>
                                        </div>
                                        <div class="input-box">
                                            <span class="details"><label>Complainant's Home Address: </label></span>
                                            <input type="text" name="address" value="<?php echo $adres ?>" disabled>
                                        </div>
                                        <div class="input-box">
                                            <span class="details"><label>Crime Description:</label></span>
                                            <input type="text" name="desc" value="<?php echo $cdesc ?>" disabled>
                                        </div>
                                        <div class="input-box">
